...
<div class="min-h-screen bg-background">
    ...
    <div class="relative py-16 bg-primary text-white">
        <div class="container mx-auto px-4">
            <h1 class="text-4xl md:text-5xl font-bold text-center">Conditions Générales de Vente</h1>
            <p class="text-xl text-center mt-4 opacity-90">Astrolab - Dernière mise à jour : {{ date('d/m/Y') }}</p>
        </div>
    </div>
    ...
    <div class="container mx-auto px-4 py-16">
        ...
        <div class="flex flex-col sm:flex-row gap-4 mb-8 justify-center">
            <a href="{{ asset('documents/CGV ASTROLAB.pdf') }}" 
               target="_blank" 
        ...
        <div class="max-w-6xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden">
            <!-- PDF Viewer -->
            <div class="w-full" style="height: 1600px;">
                <iframe 
                    src="{{ asset('documents/CGV ASTROLAB.pdf') }}" 
                    class="w-full h-full"
                    style="border: none;"
                    title="Conditions Générales de Vente - Astrolab">
                    <div class="flex items-center justify-center h-full p-8">
                        <div class="text-center">
                            ...
                            <a href="{{ asset('documents/CGV ASTROLAB.pdf') }}" target="_blank" 
